...
from .vae_controlnet import Decoder, DecoderOutput, DiagonalGaussianDistribution, Encoder, zero_module, conv_nd
...
class AutoencoderKL_ControlNet(ModelMixin, ConfigMixin):
    ...
    def get_parameters(self):
        _params = []
        # Down blocks
        _params += list(self.encoder.get_parameters())
        # Final blocks
        _params += list(self.quant_conv.parameters())
        _params += list(self.post_quant_conv.parameters())
        # Zero conv blocks
